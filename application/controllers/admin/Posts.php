...
class Posts extends CI_Controller {
    ...
    function detail($id = NULL) {
        ...
        $data['main'] = 'admin/posts/posts_detail';
        $this->load->view('admin/layout', $data);
    }
    ...
    public function add($id = NULL) {
        ...
        $this->form_validation->set_rules('category_id_new', 'Kategori', 'is_unique[posts_category.category_name]');
