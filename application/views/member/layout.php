...
<html lang="en" ng-app>
    ...
    <head>
        ...
        <title>SG CMS <?php echo isset($title) ? ' | ' . $title : null; ?></title>
            ...
            <div class="main_container">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="<?php echo site_url('member') ?>" class="site_title"><i class="fa fa-windows"></i> <span>PRAKERIN</span></a>
                        </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="<?php echo media_url() ?>/images/user.png" alt=""><?php echo $text = ucfirst($this->session->userdata('member_full_name')); ?>
                ...
                <div class="right_col" role="main">
                    <div class="row">
                        ...
                        <footer class="bottom">
                            <div class="">
                                <p class="pull-right">© 2016 SG CMS-APP By Achyar Anshorie
                                </p>
                            </div>
                            <div class="clearfix"></div>
                        </footer>
